...
>
> ⚠️ **Deprecated як цільова архітектура.** Цей документ лишається чинним контрактом реалізації `@7n/mt@0.2.x`, але цільова картина (граф задач + хости, пристрої, інтерактивні сесії, relay, membership) описана в [architecture.md](architecture.md) (0.3.0-draft); стек — у [stack.md](stack.md).

---
type: guide
description: 'Деталі реалізації контракту 0.2.x: наскрізний приклад, wrapper покроково, protected main, контракт моніторингу, SWOT'
tags: [guide, wrapper, monitoring]
